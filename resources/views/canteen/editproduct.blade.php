...
@section('content')
    <div class="px-12 pt-16">
        ...
        <h1 class="text-3xl text-white font-semibold">Edit Product</h1>
        ...
        <div class="w-full  py-4">
            <form action="{{ route('kantin.updateproduct', $product->id) }}" method="POST" class="flex flex-col gap-4 w-full"
                ...
                <div class="mb-2">
                    ...
                    <input type="number" name="harga" id="price" value="{{ $product->price }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="mb-2">
                    <label for="Desc"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Desc</label>
